...
<body>
   <div class="container-fluid">
      <div class="row justify-content-center ">
         <div class="col-sm-6 col-md-4 custom-margin">
         <h3 class="text-white fornt-wight-bold text-center">Log In</h3>
            <!-- Add bg-primary in form tag if want form background color-->
            <!--text-white if want text color white-->
            <form action="validation.php" method="post" class="shadow-lg p-4 text-white">
               <div class="form-group">
                  <i class="fas fa-user"></i>
                  <label for="Name" class="pl-2 font-weight-bold">User Name</label>
                  <input type="text" class="form-control" name="logUser" placeholder="User Name">
               ...
               <div class="form-group">
                  <label class="mt-2 text-white"><a class="text-white" href="signUp.php">Please Create an Account</a></label>
               </div>
